...
## Project Structure
    ...
    ├── web_api_deploy_test_50797  # Django project configurations
...
1. Clone this repo and `cd web_api_deploy_test_50797`
...
2. Clone this repo and `cd web_api_deploy_test_50797`
